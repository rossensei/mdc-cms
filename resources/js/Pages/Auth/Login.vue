...
<template>
    <GuestLayout>
        ...
        <template #logo>
            <img src="images/mdc.jpg" alt="" class="object-cover h-5/6 w-full rounded-l-xl opacity-80 select-none">

            <div class="bg-gray-700 opacity-20 absolute top-0 h-full w-full rounded-lg"></div>
